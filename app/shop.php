        ...
        <div class="w-full flex gap-md items-center" style="border: 1px solid black">
            ...
            <div class="flex-1 flex justify-between items-center">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <a href="prod_detail.php?id=<?php echo $products_array[$i]->id ?>" class="detailsButton btn btn-md" onclick="navigateToProduct(<?php echo $products_array[$i]->id ?>)">Details..</a>
                </div>
            </div>
        </div>
    <?php } ?>
