            ...
            <div class="flex-1 flex justify-between items-center">
                <div class="flex flex-col gap-sm">
                    ...
                    <div class="flex gap-md">
                        <button class="btn btn-sm bg-red rad-xs text-white font-bold" onclick="addToCart(uname='<?php echo $username ?>', prod_id=<?php echo $products_array[$i]->id ?>)">Add to Cart</button>
